export const urlProfiles = {
  LNI: {
    id: 'LNI',
    name: 'LNI',
    loginUrl: 'http://172.16.3.2/ALiSWADLNI2TESTING11.4.40.05/LoginCMS.aspx',
  },
  NVRCP: {
    id: 'NVRCP',
    name: 'NVRCP',
    loginUrl: 'http://172.16.3.2/ALiSNVRCP2TESTING11.4.40.05/LoginRadiation.aspx',
  },
  NJ: {
    id: 'NJ',
    name: 'NJ',
    loginUrl: 'http://172.16.3.2/ALiSNJDOH2TESTING11.4.40.05/LoginNJ.aspx',
  },
  DPBH: {
    id: 'DPBH',
    name: 'DPBH',
    loginUrl: 'http://172.16.3.2/ALiSDPBH2TESTING11.4.40.05/Login.aspx',
  },
};
