export const environments = {
  TEST: {
    ...
    name: 'Testing',
    urls: {
      DPBH: 'http://172.16.3.2/ALiSDPBH2TESTING11.4.41.03/Login.aspx',
      TXOCA: 'http://172.16.3.2/ALiSTXOCA2TESTING11.4.41.03/DefaultTexas.aspx',
      NVRCP: 'http://172.16.3.2/ALiSNVRCP2TESTING11.4.41.03/LoginRadiation.aspx',
      NJ: 'http://172.16.3.2/ALiSNJDOH2TESTING11.4.41.03/LoginNJ.aspx',
      CONV: 'http://172.16.3.2/ALiSWADLNI2TESTING11.4.41.03/LoginCMS.aspx',
      CRANES: 'http://172.16.3.2/ALiSWADLNI2TESTING11.4.41.03/LoginCMS.aspx',
      SAPTA: 'http://172.16.3.2/ALiSNVSAPTA2TESTING11.4.41.03/LoginBHCEN.aspx',
      TXFSC: 'http://172.16.3.2/ALiSTXFSC2TESTING11.4.41.03/LoginTXFSC.aspx',
    },
  },
  ...
  PROD: {
    ...
    urls: {
      ...
      TXOCA: 'http://172.16.3.2/ALiSTXOCA2TESTING11.3.25.02/DefaultTexas.aspx',
      DPBH: 'http://172.16.3.2/ALiSDPBH2TESTING11.3.25.02/Login.aspx',
      NJ: 'http://172.16.3.2/ALiSNJDOH2TESTING11.3.25.02/LoginNJ.aspx',
